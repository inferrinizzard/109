...
public:
   ...
   virtual ~shape() {}
   virtual void draw(const vertex &, const rgbcolor &, bool = false, int width = 4) const = 0;
...
public:
   ...
   virtual void draw(const vertex &, const rgbcolor &, bool = false, int width = 4) const override;
